...
#define GOSSIP_DABIREE1         "Slave, Fly me to Murketh and Shaadraz Gateways"
#define GOSSIP_DABIREE2         "Slave, Fly me to Shatter Point"
#define GOSSIP_WINDBELLOW1      "Slave, Fly me to The Abyssal Shelf"
#define GOSSIP_WINDBELLOW2      "Slave, Fly me to Honor Point"
#define GOSSIP_BRACK1           "Slave, Fly me to Murketh and Shaadraz Gateways"
#define GOSSIP_BRACK2           "Slave, Fly me to The Abyssal Shelf"
#define GOSSIP_BRACK3           "Slave, Fly me to Spinebreaker Post"
#define GOSSIP_IRENA            "Slave, Fly me to Skettis please"
#define GOSSIP_CLOUDBREAKER1    "Slave, Speaking of action, I've been ordered to undertake an air strike."
#define GOSSIP_CLOUDBREAKER2    "Slave, I need to intercept the Dawnblade reinforcements."
#define GOSSIP_DRAGONHAWK       "<Ride the dragonhawk to Sun's Reach>"
#define GOSSIP_VERONIA          "Slave, Fly me to Manaforge Coruu please"
#define GOSSIP_DEESAK           "Slave, Fly me to Ogri'la please"
